...
> GitHub Actions 在云端执行，所以即使个人电脑关机，定时任务仍会运行。定时触发设置为 **UTC 06:45–11:45 每小时一次**（北京时间 14:45–19:45），并在程序层限制只有北京时间 13:00–20:00 才允许处理和推送；第一轮在 arXiv 约 14:00 更新后留出 45 分钟缓冲，若 GitHub 延迟则由后续时段继续尝试，夜间会安全跳过。也可在 Actions 页面手动运行。
